    ...
    public double calculate(int size, int count) {
        ...
        for (int i=0; i<count; i++) {
            ...
            for (int j=0; j<size; j++){
                int birthday_of_this_person = random.nextInt(365);
                birthdays[birthday_of_this_person] = birthdays[birthday_of_this_person] + 1;

                if (birthdays[birthday_of_this_person] >= 2) {
        ...
        return (duplicate_count*100.0) / count;
    }
